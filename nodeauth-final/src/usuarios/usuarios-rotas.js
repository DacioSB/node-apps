...
module.exports = app => {
  app.route('/usuario/trocar_senha')
  ...
  app
    .route('/usuario/:id')
    .delete([middlewaresAutenticacao.bearer, middlewaresAutenticacao.local, autorizacao('usuario', 'deletar')], usuariosControlador.deleta)
}
